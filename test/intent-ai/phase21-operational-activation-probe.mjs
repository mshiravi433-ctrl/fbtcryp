...
try {
  ...
  try {
    ...
    check('activation still separates implementation from operational proof', activation.body.product.specificationImplementedThrough === 30 && activation.body.product.operationalActivationRequired === true);
