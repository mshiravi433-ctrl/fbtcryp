...
/**
 * Bundles the adapter shim the Arbitrum fork probe imports.
 *
 * Same reason as test/vite.units.mjs: the app's modules use extensionless
...
export default defineConfig({
  ...
  define: {
     ...
     */
    __AAVE_ARB_SUPPLY_ENABLED__: 'false'
  },
  build: {
    ssr: 'test/aave-arbitrum-fork-adapter.mjs',
    outDir: 'test/.out/aavearb',
    emptyOutDir: true,
