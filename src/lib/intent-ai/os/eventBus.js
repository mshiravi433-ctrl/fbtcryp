...
export const EVENTS = Object.freeze({
  ...
  LENDING_POSITION_UPDATED: 'lending.updated',
  FARM_POSITION_UPDATED: 'farm.updated',
  LP_POSITION_UPDATED: 'lp.updated',
  FUTURES_POSITION_UPDATED: 'futures.updated',
  DYDX_POSITION_UPDATED: 'dydx.updated',
