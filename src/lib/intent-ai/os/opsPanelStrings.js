...
export const OPS_PANEL_STRINGS = {
  ...
  'opp.kindMarket':    { fa: 'بازار',             en: 'Market',      ar: 'السوق' },
  'opp.kindYield':     { fa: 'بازده',             en: 'Yield',       ar: 'العائد' },
  'opp.kindFarm':      { fa: 'فارم',              en: 'Farm',        ar: 'المزرعة' },
  'opp.kindLending':   { fa: 'وام‌دهی',           en: 'Lending',     ar: 'الإقراض' },
  'opp.basisApy':      { fa: '٪ سالانه',          en: 'APY',         ar: 'سنوي' },
  'opp.basisTrend':    { fa: 'روند ۷روزه',        en: '7d trend',    ar: 'اتجاه ٧ أيام' },
  'opp.riskLow':       { fa: 'ریسک کم',           en: 'Low risk',    ar: 'مخاطر منخفضة' },
  'opp.riskMedium':    { fa: 'ریسک متوسط',        en: 'Medium risk', ar: 'مخاطر متوسطة' },
  'opp.riskHigh':      { fa: 'ریسک زیاد',         en: 'High risk',   ar: 'مخاطر عالية' },
  'opp.drawdown':      { fa: 'افت',               en: 'DD',          ar: 'التراجع' },
  'opp.note': {
