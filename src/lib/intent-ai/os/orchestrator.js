...
export function createOrchestrator({
  ...
  return {
    ...
    async plan({ intent, context = {}, perception = null } = {}) {
      ...
      } else if (['PORTFOLIO_ANALYSIS', 'MARKET_ANALYSIS', 'RISK_ANALYSIS', 'WALLET_BALANCE', 'SMART_MONEY', 'WHALE', 'YIELD_DISCOVERY', 'ANALYZE_TOKEN', 'FARM', 'LEND', 'STAKING', 'GOAL', 'REBALANCE'].includes(type)) {
        actions.length = 0;
