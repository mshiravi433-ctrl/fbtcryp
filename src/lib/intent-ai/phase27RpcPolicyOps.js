...
export function operateRpcQuorum({ rpc = null, deployment = null } = {}) {
  if (!rpc || rpc.available !== true || rpc.attested !== true) return unavailable('RPC_OUTAGE', null, { schema: PHASE27_SCHEMA, success: false });
...
export function enforceOnchainPolicy({ localDigest = null, onchainDigest = null, readable = true } = {}) {
  ...
  return { ok: true, schema: PHASE27_SCHEMA, authoritative: 'on-chain', operational: false };
}
