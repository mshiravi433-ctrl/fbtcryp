...
const KB = [
  ...
  },
  {
    ...
    a: {
      en: 'Swaps run on sixteen EVM networks: BNB Chain, Ethereum, Polygon, Arbitrum, Base, Optimism, Avalanche, Linea, Sonic, Mantle, Berachain, Unichain, Monad, Scroll, zkSync Era and Robinhood Chain. Solana has its own swap screen, for seventeen supported swap networks in total. For moving eligible assets BETWEEN networks — say USDT on BNB Chain to USDC on Arbitrum — use the Bridge screen. It only shows routes a provider can quote for the chosen asset and destination, and shows the full cost before you sign.',
      fa: 'سواپ روی شانزده شبکه EVM انجام می‌شود: BNB Chain، اتریوم، پالیگان، آربیتروم، بیس، اپتیمیسم، آوالانچ، لینیا، سونیک، منتل، براچین، یونی‌چین، موناد، اسکرول، زک‌سینک ارا و رابین‌هود چین. سولانا هم صفحهٔ سواپ جدا دارد؛ یعنی در مجموع هفده شبکهٔ سواپ پشتیبانی می‌شود. برای جابه‌جایی دارایی‌های قابل‌پشتیبانی بین شبکه‌ها — مثلاً تتر روی BNB به USDC روی آربیتروم — از صفحه «پل» استفاده کن. فقط مسیرهایی نمایش داده می‌شوند که سرویس‌دهنده برای دارایی و مقصد انتخاب‌شده بتواند quote واقعی بدهد و هزینهٔ کامل پیش از امضا نشان داده می‌شود.',
      ar: 'يعمل التبادل على ست عشرة شبكة EVM: BNB Chain والإيثريوم وبوليجون وأربيتروم وبيس وأوبتيميزم وأفالانش ولينيا وسونيك ومانتل وبيراتشين ويوني تشين وموناد وسكرول و zkSync Era و Robinhood Chain. ولسولانا شاشة تبديل خاصة، أي سبع عشرة شبكة مدعومة إجمالاً. للانتقال بين الشبكات استخدم شاشة الجسر؛ لا تظهر إلا المسارات التي يستطيع مزود الخدمة تسعيرها للأصل والوجهة المختارين، مع التكلفة الكاملة قبل التوقيع.'
    }
  },
  {
    id: 'realMoney',
