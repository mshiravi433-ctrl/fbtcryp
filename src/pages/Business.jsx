...
const STEPS = [
  { n: ۱, title: 'گفتگو', desc: 'فرم زیر را پر کن یا مستقیم ایمیل بزن — موضوعت را می‌فهمیم، نه قالب می‌فرستیم.' },
  { n: ۲, title: 'پیشنهاد', desc: 'بر اساس توکن/شبکه/حجم‌ات، مسیر فنی و کارمزد را پیشنهاد می‌دهیم.' },
  { n: ۳, title: 'اجرا', desc: 'لیست شدن، عمق نقدینگی یا وایت‌لیبل — تست روی شبکهٔ اصلی و لانچ.' },
];
