...
export const EVENT_TYPES = Object.freeze([
  ...
  /* Futures Engine v3 (spec §15) — the same names the browser bus uses. */
  'FUTURES_MARKET_SELECTED', 'FUTURES_PROVIDER_CHANGED', 'FUTURES_PROVIDER_HEALTH_CHANGED',
  ...
  'FUTURES_ORDER_REJECTED', 'FUTURES_POSITION_OPENED', 'FUTURES_POSITION_UPDATED',
  'FUTURES_POSITION_CLOSED', 'FUTURES_TP_SL_UPDATED', 'FUTURES_FEE_RECORDED',
  'FUTURES_ALERT_TRIGGERED', 'FUTURES_STRATEGY_STARTED', 'FUTURES_STRATEGY_STOPPED',
  'INSURANCE_QUOTE_CREATED', 'INSURANCE_QUOTE_EXPIRED', 'COVERAGE_PURCHASE_STARTED',
  'COVERAGE_ACTIVATED', 'COVERAGE_EXPIRED', 'INCIDENT_DETECTED', 'CLAIM_CREATED',
  'CLAIM_SUBMITTED', 'CLAIM_UPDATED', 'CLAIM_APPROVED', 'CLAIM_REJECTED',
  'INSURANCE_PAYOUT_DETECTED', 'INSURANCE_PAYOUT_VERIFIED',
  'INSURANCE_PROVIDER_HEALTH_CHANGED', 'INSURANCE_FEE_COLLECTED', 'COMMISSION_RECORDED'
]);
