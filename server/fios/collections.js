...
/** §46 — the requested tables, as key namespaces. Phase 211 ADDS the two
 *  global-intelligence collections at the end; existing names and their rows
 *  are untouched, and `read()` of a collection an old build wrote is exactly
 *  what it was before (keys are namespaced per collection). */
