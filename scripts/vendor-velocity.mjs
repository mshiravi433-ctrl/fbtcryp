/**
 * Pre-bundle the Velocity + Solana SDK stack into ONE browser-ready ESM file
 * (public/vendor/velocity-sdk.js) with esbuild.
 *
 * The venue is Velocity Protocol (the Drift fork; the Drift program is paused),
 * so this bundles @velocity-exchange/sdk.
 *
 * Why: feeding @velocity-exchange/sdk (~2700 CJS modules with anchor/coral/solana
 ...
 * run directly: `node scripts/vendor-velocity.mjs`.
 */
...
const outfile = resolve(root, 'public/vendor/velocity-sdk.js');
...
const entryFile = resolve(root, 'scripts/.vendor-velocity-entry.generated.mjs');
writeFileSync(entryFile, [
  '/* AUTO-GENERATED by scripts/vendor-velocity.mjs — do not edit. */',
  `export { ${names.join(', ')} } from '@velocity-exchange/sdk';`,
...
console.log('✓ Velocity vendor bundle written to public/vendor/velocity-sdk.js');
