...
const NETWORKS = { 1: 'ethereum', 56: 'binance-smart-chain', 137: 'polygon', 42161: 'arbitrum-one', 8453: 'base', 10: 'optimism', 43114: 'avalanche', 59144: 'linea', 146: 'sonic', 5000: 'mantle', 80094: 'berachain', 130: 'unichain', 143: 'monad', 534352: 'scroll', 324: 'zksync-era', tron: 'tron', solana: 'solana', bitcoin: 'bitcoin', cosmos: 'cosmos', litecoin: 'litecoin', ton: 'ton', xrp: 'xrp' };
