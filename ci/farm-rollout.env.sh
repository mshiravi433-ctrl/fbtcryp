...
# VITE_*_MAX_*             hard caps, enforced in the adapter, not the UI.
#
...
export VITE_AAVE_BASE_SUPPLY_MAX_USDC_PER_TX="${VITE_AAVE_BASE_SUPPLY_MAX_USDC_PER_TX:-1000}"
export VITE_AAVE_BASE_SUPPLY_MAX_USDC_TOTAL="${VITE_AAVE_BASE_SUPPLY_MAX_USDC_TOTAL:-10000}"
...
export VITE_AAVE_ARB_SUPPLY_MAX_USDC_PER_TX="${VITE_AAVE_ARB_SUPPLY_MAX_USDC_PER_TX:-1000}"
export VITE_AAVE_ARB_SUPPLY_MAX_USDC_TOTAL="${VITE_AAVE_ARB_SUPPLY_MAX_USDC_TOTAL:-10000}"
...
export VITE_COMPOUND_BASE_SUPPLY_MAX_USDC_PER_TX="${VITE_COMPOUND_BASE_SUPPLY_MAX_USDC_PER_TX:-1000}"
export VITE_COMPOUND_BASE_SUPPLY_MAX_USDC_TOTAL="${VITE_COMPOUND_BASE_SUPPLY_MAX_USDC_TOTAL:-10000}"
...
export VITE_LIDO_STAKE_MAX_ETH_PER_TX="${VITE_LIDO_STAKE_MAX_ETH_PER_TX:-1}"
export VITE_LIDO_STAKE_MAX_ETH_TOTAL="${VITE_LIDO_STAKE_MAX_ETH_TOTAL:-10}"
...
export VITE_MORPHO_BASE_SUPPLY_MAX_USDC_PER_TX="${VITE_MORPHO_BASE_SUPPLY_MAX_USDC_PER_TX:-1000}"
export VITE_MORPHO_BASE_SUPPLY_MAX_USDC_TOTAL="${VITE_MORPHO_BASE_SUPPLY_MAX_USDC_TOTAL:-10000}"
