...
> برای راستی‌آزماییِ پیشنهادهای توسعه و وضعیت فعلی صفحات، [ممیزی سئو ۲۵ سپتامبر ۲۰۲۶](SEO-AUDIT-2026-09-25-FA.md) را ببین. پس از build آزمون `npm run test:seo` را نیز اجرا کن.
...
> اف‌بی‌تی سواپ یک رابط غیرامانی برای سواپ ارز دیجیتال روی ۱۷ شبکه است. کلید و دارایی نزد کیف پول کاربر می‌ماند و هر تراکنش با امضای خودش انجام می‌شود.

### English (under 160 characters)

> FBT Swap is a non-custodial crypto swap interface on 17 networks. Users keep their keys and sign every transaction from their own wallet.
